    ...
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-10">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center cursor-pointer">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Pixl Technical Test.{' '}
              <a href="https://github.com/josebladex" className="font-semibold text-indigo-600">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-indigo-800 sm:text-7xl">
